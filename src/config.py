...
stim_dir = '/root/data/nsd/nsddata_stimuli/stimuli/nsd/'
mask_dir = '/root/data/nsd/masks/'    
voxel_dir = '/root/data/nsd/voxels/'

#exp_design_file = root_dir+"../../data/nsd/nsd_expdesign.mat"   
exp_design_file = "/root/data/nsd/nsddata/experiments/nsd/nsd_expdesign.mat"   
